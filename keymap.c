...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------------------------------------------------------------------------------|
     * |FN   | Gui | Alt |     CTRL+ALT+GUI / Space     |Alt |Gui | FN |Left|Down|Rght|
     * `------------------------------------------------------------------------------'
     */
    [_BASE] = KEYMAP( \
        ...
        CTL_T(KC_ESC),     GUI_T(KC_A),  KC_S,     KC_D,  KC_F,  KC_G,  KC_H,  KC_J,  KC_K,  KC_L,     LT(_MOUSE, KC_SCLN),  ALT_T(KC_QUOTE),   KC_NUHS,  RCTL_T(KC_ENT),               KC_PGUP,  \
        KC_LSFT,           KC_NUBS,      KC_Z,     KC_X,  KC_C,  KC_V,  KC_B,  KC_N,  KC_M,  KC_COMM,  KC_DOT,               KC_SLSH,           KC_RSFT,  KC_UP,                        KC_PGDN,  \
        LT(_LFN, KC_GRV),  KC_LGUI,      KC_LALT,              LCAG_T(KC_SPC),               KC_RALT,  KC_RGUI,              LT(_RFN, KC_APP),  KC_LEFT,  KC_DOWN,                      KC_RGHT   \
    ),
